...
const MS_COLUMNS = [
  ...
  { label: File_Name_Column, fieldName: "fileName", type: "text", initialWidth: 350, hideDefaultActions: true },
  { label: Manageable_State_Column, fieldName: "manageableState", type: "text", fixedWidth: 125, hideDefaultActions: true },
